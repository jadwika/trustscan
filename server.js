const FAKE_EXTENSIONS = ['xyz','tk','ml','ga','cf','gq','top','club','online','site','buzz','icu','fun','pw','cc','ws','biz','info','mobi'];
...
const FAKE_KEYWORDS = [
  ...
  'clearance-sale','stock-clearance','medicine-discount',
  'free-food','food-offer','flight-offer','hotel-deal',
  'gold-cheap','jewellery-sale','furniture-sale'
];
...
const BRAND_NAMES = [
  ...
  'swiggy','zomato','makemytrip','cleartrip','yatra','goibibo','easemytrip',
